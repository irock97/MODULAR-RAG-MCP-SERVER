...
|-------|-------|-------------|------------|
| 1 | `spec-sync` | Sync spec documents | `.calude/skills/spec-sync/SKILL.md` |
| 2 | `progress-tracker` | Find next task | `.calude/skills/progress-tracker/SKILL.md` |
| 3 | `implement` | Execute implementation | `.calude/skills/implement/SKILL.md` |
| 4 | `testing-stage` | Run tests | `.calude/skills/testing-stage/SKILL.md` |
| 5 | `checkpoint` | Save progress | `.calude/skills/checkpoint/SKILL.md` |
