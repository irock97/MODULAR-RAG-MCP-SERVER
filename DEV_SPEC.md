...
|---------|---------|------|---------|------|
| A1 | 初始化目录树与最小可运行入口 | [x] | 2025-02-10 | ✅ 完成 |
| A2 | 引入 pytest 并建立测试目录约定 | [x] | 2025-02-11 | ✅ pytest 基座已就绪，10 个冒烟测试通过 |
| A3 | 配置加载与校验（Settings） | [x] | 2025-02-11 | ✅ Settings dataclass + 验证，25 个测试通过 |
...
| 任务编号 | 任务名称 | 状态 | 完成日期 | 备注 |
|---------|---------|------|---------|------|
| C1 | 定义核心数据类型/契约（Document/Chunk/ChunkRecord） | [x] | 2025-02-13 | ✅ Document/Chunk/ChunkRecord + 序列化 + 22 测试通过 |
| C2 | 文件完整性检查（SHA256） | [x] | 2025-02-13 | ✅ FileIntegrityChecker 抽象类 + SqliteFileIntegrityChecker + 21 测试 |
...
| C8 | DenseEncoder | [x] | 2025-02-19 | ✅ batch_size 修复 + TF-IDF 移除 + 581 测试 |
...
| D6 | Reranker（Core 层编排 + Fallback） | [x] | 2026-02-26 | ✅ CoreReranker + 17测试 + Candidate.metadata |
