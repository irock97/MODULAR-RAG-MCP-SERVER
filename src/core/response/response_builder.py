...
def create_response_builder(
    ...
    """Create a ResponseBuilder with optional configuration.

    Args:
        citation_generator: Optional CitationGenerator instance.
        max_results_in_content: Maximum results to show in Markdown content.
        snippet_max_length: Maximum characters per result snippet.
    ...
    return ResponseBuilder(
        ...
        max_results_in_content=max_results_in_content,
